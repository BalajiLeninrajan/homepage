...
(() => {
  ...
  const prePath = `#pre-path {color: ${command.colors.prompt.path}}`;
  const preAt = `#pre-at {color: ${command.colors.prompt.at}}`;
  ...
  if (!command.colors.border.visible) {
    ...
    style.sheet.insertRule(
      `#bar-2 {background: ${command.colors.border.color}}`,
    );
    style.sheet.insertRule(
      `#bar-3 {background: ${command.colors.border.color}}`,
    );
    style.sheet.insertRule(
      `#bar-4 {background: ${command.colors.border.color}}`,
    );
    style.sheet.insertRule(
      `#bar-5 {background: ${command.colors.border.color}}`,
    );
  }
  ...
  style.sheet.insertRule(prePath);
  style.sheet.insertRule(preAt);
